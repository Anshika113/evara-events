...
export default function FloatingButtons() {
  return (
    <div className="fab">
      <a className="fab__btn fab__btn--wa" href={whatsappLink()} target="_blank" rel="noreferrer" aria-label="Chat on WhatsApp" title="Chat on WhatsApp">
      ...
      <a className="fab__btn fab__btn--call" href={`tel:${business.phone}`} aria-label="Call us" title="Call us">
